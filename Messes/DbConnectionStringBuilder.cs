    ...
    public class DbConnectionStringBuilder : System.Collections.IDictionary, ICustomTypeDescriptor {
        ...
        private string ObjectToString(object keyword) {
            try {
                ...
                // BUGBUG: 1. wrong order of the keyword and message parameters to ArgumentException
                // BUGBUG: 2. the message is not localized.
                // See Dev11 bug 875012 for user scenario.
                // Remember to remove FXCOP warning on this method when this bug is fixed.
