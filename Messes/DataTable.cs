...
// <owner current="true" primary="false">aconrad</owner>
//------------------------------------------------------------------------------
...
//                (action == DataRowAction.Rollback && row.tempRecord != -1));
        ...
        public virtual void Load (IDataReader reader, LoadOption loadOption, FillErrorEventHandler errorHandler){
            ...
            try {
                ...
                if (!reader.IsClosed && !reader.NextResult()) { // TODO: bad design choice to move to next result
                    reader.Close();
                }
            }
            finally {
    ...
    // amirhmy                    xmlload.InferSchema(xdoc, null);
    // amirhmy                    xmlload.LoadData(xdoc);
                    }
                }
                RestoreConstraint(originalEnforceConstraint);
